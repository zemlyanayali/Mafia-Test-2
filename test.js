const questions = [
    ...
    {
        questionText: 'В каких из перечисленных ситуаций Судья должен присудить игрокам большой штраф в размере -0.5 балла?
                    Возможность согласования штрафа с представителем СК не учитывается.',
        answerOptions: [
